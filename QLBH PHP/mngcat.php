...
<html xmlns="http://www.w3.org/1999/xhtml"><!-- InstanceBegin template="/Templates/frontend.dwt.php" codeOutsideHTMLIsLocked="false" -->
    ...
    <body>
        ...
        if (isset($_GET["id"])) {
            $flag = true;
            $s_id = $_GET["id"];
            $sql = "select * from   categories where ID=" . $s_id;
        ...
        <div class="main-dash">
            <div class="menu-dash">
                <ul>
                    ...
                    <li class="tab active"><i class="fa fa-th-list fa-2x"></i> Quản lý
                        <ul>
                            <a href="mngcat.php"><li class="tab2 active"><i class="fa fa-th-large"></i> Loại sản phẩm</li></a>
            ...
            <div class="content-dash">
                <div class="content-h4">Quản lý loại sản phẩm</div>
                <hr class="style-two"/>
                <br/>
                    ...
                    <table style="width: 400px !important;">
                        ...
                        while ($row = mysql_fetch_array($list)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn" href="mngcat.php?id=<?php echo $row["ID"]; ?>">Chọn</a>
                                </td>
                                <td>
                                    <a class="btn" href="mngcatdel.php?id=<?php echo $row["ID"]; ?>">Xóa</a>
                                </td>
                            </tr>
                            <?php
                        }
                ...
                <p>
                    <div class="form">
                        <form action="mngcat.php" method="post" name="frmCat" id="frmCat">
                            <div class="label">Mã loại </div>
                            <input class="text" name="txtID" id="txtID" type="text" readonly="readonly" value="<?php if ($flag) echo $s_id; ?>" />
                            <div class="label">Tên loại </div>
                            <input class = "text" name="txtCatName" id="txtCatName" type="text" value="<?php if ($flag) echo $s_catname; ?>" />
                            <?php if (!$flag) { ?>
